...
public class IMSEntryPoint {
    ...
    public IMSEntryPoint() {
        ...
        this.orders = new OrderController(ordDAO, javaUtilities);
        
        final ItemDao itmDAO = new ItemDao();
        this.items = new ItemController(itmDAO, javaUtilities);
    }
    ...
    private void chooseDomain(DomainMenu domainMenu) {
        ...
        do {
            ...
            if ( domainMenu.name() != null ) {
            	LOGGER.info( String.format( "What would you like to do with %s:", domainMenu.name().toLowerCase() ) );
            }
